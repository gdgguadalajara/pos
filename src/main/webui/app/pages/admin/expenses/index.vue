...
const { params, setParam } = useParams('adminGetApiExpensesParams', { page: 1 })
...
<template>
    <div>
        <NuxtLayout name="admin" title="Gastos">
                        ...
                        <table class="table table-zebra">
                            ...
                            <tbody>
                                ...
                                <tr v-if="status == 'success'" v-for="expense in paginatedExpenses.data"
                                    ...
                                    <td>
                                        <NuxtLink :to="`/admin/cash-sessions?id=${expense.cashSession.id}`"
                                            target="_blank" class="btn btn-outline btn-sm btn-primary tooltip"
                                            data-tip="Ver sesión de caja">
