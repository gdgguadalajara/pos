INSERT INTO user_pos (createdat, updatedat, id, email, name) VALUES
    ...
    (NOW(),NOW(), '7717a1bf-ea2e-4260-a847-9219a2444b7f', 'bartender@gdgguadalajara.com', 'bartender'),
    (NOW(),NOW(), '7840d15d-fdce-4fb9-a711-d8394675584a', 'chef@gdgguadalajara.com', 'chef');
...
INSERT INTO account (createdat, updatedat, id, user_id, password, role, status, username) VALUES
    ...
    (NOW(),NOW(),'0f845b3f-8531-4bc0-8f60-528760d92373','7717a1bf-ea2e-4260-a847-9219a2444b7f','96bd79d307d1fbe7d13cc72b72c2594d0d53ff27a2ec2a2d7b360e8e9ebaaca2', 'PREPARER', 'ACTIVE', 'bartender'),
    (NOW(),NOW(),'bd4a6f2d-9905-4aac-9e33-58166f314bd0','7840d15d-fdce-4fb9-a711-d8394675584a','51daaf1dbbdf798f865952ff68530a00dcd3ce00c4361c8447caec558dafaab2', 'PREPARER', 'ACTIVE', 'chef');
